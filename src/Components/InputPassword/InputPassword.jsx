...
const InputPassword = ({datoSolicitado, nombreDato, value, change }) => {
    const [mostrar,setMostrar] = useState(false);
    const verContraseña = () => setMostrar(!mostrar);
    return(
        <InputGroup>
            <Input type={mostrar ? "text" : "password"} name={nombreDato} placeholder={datoSolicitado} value={value} onChange={change} />
            <InputRightElement>
